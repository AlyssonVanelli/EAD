...
function whoAreYou() {
  ...
  Swal.fire({
    ...
    position: "center",
    imageUrl: "../images/logoahavat.png",
  ...
  // popup text
  tippy(initAudioBtn, {
    content: "Desligar microfone",
    placement: "top",
  });
  tippy(initVideoBtn, {
    content: "Desligar camera",
    placement: "top",
  });
}
...
function welcomeUser() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>Bem vindo " + myPeerName + "</strong>",
    imageAlt: "Teams",
    imageUrl: "../images/microsoft-teams-1.svg",
    html:
      `
      <br/> 
      <p style="color:white;">Compartilhe este link para convidar os alunos</p>
...
function setTheme(theme) {
  ...
  switch (roomTheme) {
    case "dark":
      ...
      document.documentElement.style.setProperty("--private-msg-bg", "#70a0f7");
 ...
 * Press Esc to exit from full screen mode.
 *
 * @param {*} videoId
...
function startStreamRecording() {
  ...
  recordStreamBtn.style.setProperty("--btn-color", "red");
  startRecordingTime();
...
function stopStreamRecording() {
  ...
  recordStreamBtn.style.setProperty("--btn-color","white")
  // setRecordButtonUi();
}
...
function setRecordButtonUi() {
    recordStreamBtn.style.setProperty("background-color", "var(--btn-bg)");
}
